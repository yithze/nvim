...
if has("gui_running") || &t_Co == 256
    ...
    hi Number cterm=NONE ctermfg=196 ctermbg=16 gui=NONE guifg=#7e8aa2 guibg=000000
    ...
    hi DiffText cterm=bold ctermfg=250 ctermbg=196 gui=bold guifg=#bcbcbc guibg=#7e8aa2
