syntax reset
let g:colors_name = "hazkel"
set background=dark
set t_Co=256

hi Normal guifg=#9b9b9b ctermbg=NONE guibg=000000 gui=NONE
...
hi Debug                    guifg=#52398e guibg=NONE
...
hi IncSearch                guifg=#343645 guibg=#00ff00
hi Include                  guifg=#9498a6 guibg=NONE
hi Keyword                  guifg=#9498b7 guibg=NONE
hi Label                    guifg=#52398e guibg=NONE
hi LineNr                   guifg=#57616c guibg=NONE
hi LocalHighlight           guibg=#272834
hi Macro                    guifg=#52398e guibg=NONE
hi MatchParen               guifg=#ff6700 guibg=NONE
hi MoreMsg                  guifg=#52398e guibg=NONE
hi NeoTreeModified          guifg=#ff6700
hi NeoTreeFolder            guifg=#ffff00 guibg=#ff0000
hi NonText                  guifg=#57616c guibg=NONE
hi Number                   guifg=#ff6700 guibg=NONE
...
hi Tag                      guifg=#807B90 guibg=NONE
hi TelescopeBorder          guifg=#000000
hi TelescopeNormal          guifg=#9498a6
